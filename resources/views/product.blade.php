    ...
    <div class="product-section container cleafix">
        ...
        <div class="product-section-information">
            ...
            <form action="{{ route('checkout.show', $product->slug) }}" method="get">
                <select style="background-image: url({{ asset('img/dropdown.png') }});" class="quantity" name="quantity" id="quantity" data-id="{{ $product->rowId }}" data-productQuantity="{{ $product->quantity }}">
